        ...
        <div className={styles.container}>
          <div className={styles.introGrid}>
            ...
            <div>
              ...
              <p>
                That background helps Kenny&apos;s Folder Services support shops
                in a practical way. Kenny understands what happens when a folder
                is down, when a job will not dial in, when parts are worn, or
                when operators need better support to keep production moving.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className={styles.finalCta}>
        <div className={styles.container}>
          ...
          <p>
            ...
            operator training, Kenny&apos;s Folder Services can help you figure
            out the next step.
          </p>
